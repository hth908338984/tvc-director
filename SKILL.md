---
name: tvc-director
description: "TVC advertising creative director for product commercials, brand films, product hero videos, ad storyboards, Nano Banana Pro keyframe prompts, and Seedance or Jimeng video scripts. Use when users ask to make a product ad, TVC, commercial video, storyboard, brand film, product launch film, or advertising visual content. Covers creative concepts, product multiview prompts, cinematic product breakdowns, brand-world crosscuts, lifestyle films, 3x3 storyboard grids, End Frames, and Multi-Phase video prompts."
---
